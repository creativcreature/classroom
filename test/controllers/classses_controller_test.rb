...
class ClasssesControllerTest < ActionController::TestCase
  ...
  test "should create classs" do
    assert_difference('Classs.count') do
      post :create, classs: { building: @classs.building, credits: @classs.credits, subject: @classs.subject }
    end
  ...
  test "should update classs" do
    patch :update, id: @classs, classs: { building: @classs.building, credits: @classs.credits, subject: @classs.subject }
    assert_redirected_to classs_path(assigns(:classs))
  end
